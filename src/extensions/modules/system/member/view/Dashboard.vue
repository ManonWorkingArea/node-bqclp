    ...
    methods: {
        async getProfile() {
            try 
            {
                ...
                const resAPI = await fetch("https://asia-southeast2-elearning-6871c.cloudfunctions.net/users/",
                {
                  method: 'GET',
...
<template>
  ...
  <!-- Page header -->
  <div class="mt-8 mx-auto max-w-3xl px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-4">
  ...
  <div class="mx-auto mt-8 grid max-w-3xl grid-cols-1 gap-6 sm:px-4 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
