        ...
        <div class="mx-auto max-w-7xl px-6 sm:px-6 lg:px-6">
            ...
            <div class="mt-2 md:flex md:items-center md:justify-between  border-b pb-5 mb-5">
              ...
              <div class="mt-4 flex flex-shrink-0 md:mt-0 md:ml-4">
                <button @click="$router.push('/'+ParentPage)" type="button" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"><font-awesome-icon :icon="['fas','chevron-left']" class="text-gray-200 mr-2"/> ย้อนกลับ</button>
                <button @click="$router.push('/'+PagePath+'/add')" type="button" class="ml-3 inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"><font-awesome-icon :icon="['fas','plus']" class="text-gray-200 mr-2"/> เพิ่มข้อมูลใหม่</button>
              </div>
            </div>
                      ...
                      <tbody class="divide-y divide-gray-200 bg-white">
                        <tr>
                          ...
                          <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-md font-medium sm:pr-6">
                                ...
                                <button type="button" class="inline-flex justify-center rounded-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2">
