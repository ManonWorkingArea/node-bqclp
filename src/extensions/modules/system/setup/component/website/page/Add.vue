  ...
  methods: {
    async addData() {
      try {
        ...
        if(finalRes.success) {
          window.location.href = "/setup/website"
        }
                      ...
                      <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow mb-8">
                        ...
                        <div class="px-4 py-5 sm:p-6">
                          ...
                          <div class="col-span-4 sm:col-span-2">
                            ...
                            <input v-model="type" type="text" name="type" id="type" autocomplete="type" class="mt-1 block w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-gray-900 focus:outline-none focus:ring-gray-900 sm:text-sm">
                          </div>
